...
Hierbei handelt es sich nur um ein Notizbuch in dem ich über React.js sinniere

Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `github_username`, `repo_name`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `React.js - Cheatsheet`, `Sammlung von React Know-How`
...
Es ist im Grunde ganz einfach. Du liest dir das hier durch und verfolgst meinen Leidensweg. Eventuell fühlst du dich mir nahe und lernst noch was.

### Prerequisites

Um mit React zu arbeiten brauchst du natürlich React. Als ich das letzte mal geguckt hab war create-react-app gerade auf dem weg nach draußen.

Also Ich gehe es so an das ich Next.js nutze aber den serverseitigen Krams ignoriere. <br/>
Grund ist das Next.js besser betreut wird und eine große Community bietet.<br/>
(<small style="color:#D6D3">Die Waffel nehme ich mit extra Schlagwort</small>)
...
Es gibt verschiedene Möglichkeiten Konditionell zu rendern

<br />

#### Außerhalb des Return-Statements:
...
[logische && Syntax](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Logical_AND#short-circuit_evaluation) = nur wenn alles <span style="color:green">**true**</span> ist kommt <span style="color:green">**true**</span> zurück, ansonsten <span style="color:red">**false**</span>
...
```jsx
// Update state anhand seines vorherigen Wertes
